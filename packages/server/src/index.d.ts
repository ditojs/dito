...
declare namespace Dito {
  ...
  class Model extends objection.Model {
    ...
    findOne: QueryBuilder<this>['findOne']
    findById: QueryBuilder<this>['findById']

    withGraph: QueryBuilder<this>['withGraph']
    withGraphFetched: QueryBuilder<this>['withGraphFetched']
    withGraphJoined: QueryBuilder<this>['withGraphJoined']
    clearWithGraph: QueryBuilder<this>['clearWithGraph']

    withScope: QueryBuilder<this>['withScope']
    applyScope: QueryBuilder<this>['applyScope']
    clearWithScope: QueryBuilder<this>['clearWithScope']

    clear: QueryBuilder<this>['clear']
    pick: QueryBuilder<this>['pick']
    omit: QueryBuilder<this>['omit']
    select: QueryBuilder<this>['select']

    insert: QueryBuilder<this>['insert']
    upsert: QueryBuilder<this>['upsert']
    update: QueryBuilder<this>['update']
    relate: QueryBuilder<this>['relate']
    patch: QueryBuilder<this>['patch']

    truncate: QueryBuilder<this>['truncate']
    delete: QueryBuilder<this>['delete']
    deleteById: QueryBuilder<this>['deleteById']

    insertAndFetch: QueryBuilder<this>['insertAndFetch']
    upsertAndFetch: QueryBuilder<this>['upsertAndFetch']
    updateAndFetch: QueryBuilder<this>['updateAndFetch']
    patchAndFetch: QueryBuilder<this>['patchAndFetch']
    updateAndFetchById: QueryBuilder<this>['updateAndFetchById']
    patchAndFetchById: QueryBuilder<this>['patchAndFetchById']

    insertGraph: QueryBuilder<this>['insertGraph']
    upsertGraph: QueryBuilder<this>['upsertGraph']
    insertGraphAndFetch: QueryBuilder<this>['insertGraphAndFetch']
    upsertGraphAndFetch: QueryBuilder<this>['upsertGraphAndFetch']

    insertDitoGraph: QueryBuilder<this>['insertDitoGraph']
    upsertDitoGraph: QueryBuilder<this>['upsertDitoGraph']
    updateDitoGraph: QueryBuilder<this>['updateDitoGraph']
    patchDitoGraph: QueryBuilder<this>['patchDitoGraph']
    insertDitoGraphAndFetch: QueryBuilder<this>['insertDitoGraphAndFetch']
    upsertDitoGraphAndFetch: QueryBuilder<this>['upsertDitoGraphAndFetch']
    updateDitoGraphAndFetch: QueryBuilder<this>['updateDitoGraphAndFetch']
    patchDitoGraphAndFetch: QueryBuilder<this>['patchDitoGraphAndFetch']
    upsertDitoGraphAndFetchById: QueryBuilder<
      this
    >['upsertDitoGraphAndFetchById']
    updateDitoGraphAndFetchById: QueryBuilder<
      this
    >['updateDitoGraphAndFetchById']
    patchDitoGraphAndFetchById: QueryBuilder<this>['patchDitoGraphAndFetchById']

    where: QueryBuilder<this>['where']
    whereNot: QueryBuilder<this>['whereNot']
    whereRaw: QueryBuilder<this>['whereRaw']
    whereWrapped: QueryBuilder<this>['whereWrapped']
    whereExists: QueryBuilder<this>['whereExists']
    whereNotExists: QueryBuilder<this>['whereNotExists']
    whereIn: QueryBuilder<this>['whereIn']
    whereNotIn: QueryBuilder<this>['whereNotIn']
    whereNull: QueryBuilder<this>['whereNull']
    whereNotNull: QueryBuilder<this>['whereNotNull']
    whereBetween: QueryBuilder<this>['whereBetween']
    whereNotBetween: QueryBuilder<this>['whereNotBetween']
    whereColumn: QueryBuilder<this>['whereColumn']
    whereNotColumn: QueryBuilder<this>['whereNotColumn']
    whereComposite: QueryBuilder<this>['whereComposite']
    whereInComposite: QueryBuilder<this>['whereInComposite']
    // whereNotInComposite:  QueryBuilder<Model>['whereNotInComposite']
    whereJsonHasAny: QueryBuilder<this>['whereJsonHasAny']
    whereJsonHasAll: QueryBuilder<this>['whereJsonHasAll']
    whereJsonIsArray: QueryBuilder<this>['whereJsonIsArray']
    whereJsonNotArray: QueryBuilder<this>['whereJsonNotArray']
    whereJsonIsObject: QueryBuilder<this>['whereJsonIsObject']
    whereJsonNotObject: QueryBuilder<this>['whereJsonNotObject']
    whereJsonSubsetOf: QueryBuilder<this>['whereJsonSubsetOf']
    whereJsonNotSubsetOf: QueryBuilder<this>['whereJsonNotSubsetOf']
    whereJsonSupersetOf: QueryBuilder<this>['whereJsonSupersetOf']
    whereJsonNotSupersetOf: QueryBuilder<this>['whereJsonNotSupersetOf']

    having: QueryBuilder<this>['having']
    havingIn: QueryBuilder<this>['havingIn']
    havingNotIn: QueryBuilder<this>['havingNotIn']
    havingNull: QueryBuilder<this>['havingNull']
    havingNotNull: QueryBuilder<this>['havingNotNull']
    havingExists: QueryBuilder<this>['havingExists']
    havingNotExists: QueryBuilder<this>['havingNotExists']
    havingBetween: QueryBuilder<this>['havingBetween']
    havingNotBetween: QueryBuilder<this>['havingNotBetween']
    havingRaw: QueryBuilder<this>['havingRaw']
    havingWrapped: QueryBuilder<this>['havingWrapped']

    // deprecated methods that are still supported at the moment.
    // TODO: Remove once we move to Objection 3.0

    eager: QueryBuilder<this>['eager']
    joinEager: QueryBuilder<this>['joinEager']
    naiveEager: QueryBuilder<this>['naiveEager']
    mergeEager: QueryBuilder<this>['mergeEager']
    mergeJoinEager: QueryBuilder<this>['mergeJoinEager']
    mergeNaiveEager: QueryBuilder<this>['mergeNaiveEager']
    clearEager: QueryBuilder<this>['clearEager']

    // scope:  QueryBuilder<this>['scope']
    // mergeScope:  QueryBuilder<this>['mergeScope']
    // clearScope:  QueryBuilder<this>['clearScope']
